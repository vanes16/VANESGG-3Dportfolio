  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-full overflow-hidden">
      ...
      <div className="mb-10 relative justifty-center items-center text-center mt-[-80px]">
        <motion.span
          className="font-primary text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight will-change-transform"
          initial={{ opacity: 0 }}
          animate={{
            opacity: 1,
            textShadow: [
        ...
        <br />
        <p className="text-2xl md:text-3xl font-bold text-white font-secondary mt-7">
